...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("vendors/css/ue-scroll.min.css") }}">
...
<body class="layout-3">
    <div id="app">
        ...
        <div id="ue-scroll" class="ue-scroll btn-primary arrow-white circle"></div>
        </div>
    ...
    <script src="{{ asset("vendors/js/ue-scroll.min.js") }}"></script>
